--
-- ademir_serralheriaQL database dump
--

-- Dumped from database version 15.1
-- Dumped by pg_dump version 15.1

-- Started on 2023-06-04 19:35:53 -03
...
--DROP DATABASE serralheria;
--
-- TOC entry 4470 (class 1262 OID 16440)
-- Name: serralheria; Type: DATABASE; Schema: -; Owner: ademir_serralheria
--

CREATE DATABASE serralheria WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.UTF-8';
...
CREATE SEQUENCE public.clientes_id_endereco_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.fornecedores_id_endereco_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.insumos_tem_fornecedores_id_fornecedor_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.insumos_tem_fornecedores_id_insumo_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.insumos_tem_fornecedores_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_contratam_prestadores_id_fornecedores_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_contratam_prestadores_id_orcamento_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_contratam_prestadores_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_id_orcamento_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_id_servico_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_tem_insumos_id_insumo_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_tem_insumos_id_orcamento_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.orcamentos_tem_insumos_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.prestadores_servicos_id_endereco_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.prestadores_servicos_id_prestador_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.projetos_id_orcamento_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.servicos_id_cliente_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE ONLY public.clientes ALTER COLUMN id_endereco SET DEFAULT nextval('public.clientes_id_endereco_seq'::regclass);
...
ALTER TABLE ONLY public.fornecedores ALTER COLUMN id_endereco SET DEFAULT nextval('public.fornecedores_id_endereco_seq'::regclass);
...
ALTER TABLE ONLY public.insumos_tem_fornecedores ALTER COLUMN id SET DEFAULT nextval('public.insumos_tem_fornecedores_id_seq'::regclass);
...
ALTER TABLE ONLY public.insumos_tem_fornecedores ALTER COLUMN id_insumo SET DEFAULT nextval('public.insumos_tem_fornecedores_id_insumo_seq'::regclass);
...
ALTER TABLE ONLY public.insumos_tem_fornecedores ALTER COLUMN id_fornecedor SET DEFAULT nextval('public.insumos_tem_fornecedores_id_fornecedor_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos ALTER COLUMN id_orcamento SET DEFAULT nextval('public.orcamentos_id_orcamento_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos ALTER COLUMN id_servico SET DEFAULT nextval('public.orcamentos_id_servico_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_contratam_prestadores ALTER COLUMN id SET DEFAULT nextval('public.orcamentos_contratam_prestadores_id_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_contratam_prestadores ALTER COLUMN id_orcamento SET DEFAULT nextval('public.orcamentos_contratam_prestadores_id_orcamento_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_contratam_prestadores ALTER COLUMN id_fornecedores SET DEFAULT nextval('public.orcamentos_contratam_prestadores_id_fornecedores_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_tem_insumos ALTER COLUMN id SET DEFAULT nextval('public.orcamentos_tem_insumos_id_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_tem_insumos ALTER COLUMN id_orcamento SET DEFAULT nextval('public.orcamentos_tem_insumos_id_orcamento_seq'::regclass);
...
ALTER TABLE ONLY public.orcamentos_tem_insumos ALTER COLUMN id_insumo SET DEFAULT nextval('public.orcamentos_tem_insumos_id_insumo_seq'::regclass);
...
ALTER TABLE ONLY public.prestadores_servicos ALTER COLUMN id_prestador SET DEFAULT nextval('public.prestadores_servicos_id_prestador_seq'::regclass);
...
ALTER TABLE ONLY public.prestadores_servicos ALTER COLUMN id_endereco SET DEFAULT nextval('public.prestadores_servicos_id_endereco_seq'::regclass);
...
ALTER TABLE ONLY public.projetos ALTER COLUMN id_orcamento SET DEFAULT nextval('public.projetos_id_orcamento_seq'::regclass);
...
ALTER TABLE ONLY public.servicos ALTER COLUMN id_cliente SET DEFAULT nextval('public.servicos_id_cliente_seq'::regclass);
...
-- Completed on 2023-06-04 19:35:56 -03
